...
export const RegisterSuccess = createAction('[Authentication] Register Success', props<{ user: Authentication }>());
...
export const loginSuccess = createAction('[Authentication] Login Success', props<{ user: Authentication }>());
